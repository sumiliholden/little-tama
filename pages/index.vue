  ...
  <div class="bg-white">
    ...
    <div class="relative bg-gray-900">
      ...
      <div aria-hidden="true" class="absolute inset-0 overflow-hidden">
        <img src="https://64.media.tumblr.com/aa5838e0094bfb497d1f13d781e92591/tumblr_ou2twq3KSm1ws4s25o7_1280.png" alt="" class="w-full h-full object-center object-cover" />
      </div>
      <div aria-hidden="true" class="absolute inset-0 bg-gray-900 opacity-30" />
              ...
              <div>
                <div class="h-16 flex items-center justify-between">
                  ...
                  <div class="hidden lg:flex-1 lg:flex lg:items-center">
                    <a href="#">
                      <span class="sr-only">Little Tama</span>
                      <img class="h-8 w-auto" src="../public/icon.svg" alt="" />
                    </a>
                  </div>
                  ...
                  <a href="#" class="lg:hidden">
                    <span class="sr-only">Little Tama</span>
                    <img src="../public/icon.svg" alt="" class="h-8 w-auto" />
                  </a>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="py-20 xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="mt-12 md:mt-16 xl:mt-0">
            <h3 class="text-sm font-medium text-white">Sign up for our newsletters</h3>
